...
import catan3 from '@/assets/catan/catan_3.png';
 ...
 const CATAN_DETAILS = {
  introduction: "《卡坦岛》（The Settlers of Catan），亦称《卡坦岛拓荒者》，是一款由德国设计师克劳斯·特伯（Klaus Teuber）设计的多人策略图板游戏。该游戏最初于1995年在德国由Franckh-Kosmos公司出版发行。截至2020年代，其全球累计销量已突破3000万份，正向4500万份迈进。游戏融合了资源收集、经济发展与玩家谈判等核心玩法，被认为是第一款在欧洲以外地区（特别是美国）大受欢迎的德式桌游，具有开创性意义。",
